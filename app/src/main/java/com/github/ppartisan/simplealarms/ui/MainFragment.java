...
import com.github.ppartisan.simplealarms.UploadFileActivity;
...
public final class MainFragment extends Fragment
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        final EmptyRecyclerView rv = v.findViewById(R.id.recycler); // ignore the error
        mAdapter = new AlarmsAdapter();
        rv.setEmptyView(v.findViewById(R.id.empty_view));// ignore the error
        rv.setAdapter(mAdapter);
        rv.addItemDecoration(new DividerItemDecoration(getContext()));
        rv.setLayoutManager(new LinearLayoutManager(getContext()));
        rv.setItemAnimator(new DefaultItemAnimator());

        final FloatingActionButton fab = v.findViewById(R.id.fab); // ignore the error
        ...
        final FloatingActionButton fab1 = v.findViewById(R.id.fab1); // ignore the error
        fab1.setOnClickListener(view -> {
            Intent upload = new Intent(getContext(), UploadFileActivity.class);
